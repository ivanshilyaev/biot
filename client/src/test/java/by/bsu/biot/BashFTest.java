...
public class BashFTest {
    ...
    @Test
    public void bashF() {
        String input = "B194BAC80A08F53B366D008E584A5DE48504FA9D1BB6C7AC252E72C202FDCE0D" +
        ...
        String expectedOutput = "8FE727775EA7F140B95BB6A200CBB28C7F0809C0C0BC68B7DC5AEDC841BD94E4" +
        ...
        byte[] inputBytes = HexEncoder.decode(input);
        byte[] outputBytes = LibraryNative.bash_f(inputBytes);
        String output = HexEncoder.encode(outputBytes);
